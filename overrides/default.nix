...

    {
      ...
      renoir = super.renoir.overridePythonAttrs (old: rec {
        postInstall = ''
          ...
          rm $out/lib/python3.10/site-packages/docs/tree.yml
        '';
      ...
      granian =
        let
          getRepoHash = version: {
            ...
            "0.3.0" = "sha256-hPBcpno+cFKRNNnsT0YsReqW1XLTjqERmwhGHpqFa0Y=";
      ...
      emmett-crypto =
        let
          ...
          sha256 = getRepoHash super.emmett-crypto.version;
        in
        super.emmett-crypto.overridePythonAttrs (old: rec {
          src = pkgs.fetchFromGitHub {
            owner = "emmett-framework";
            repo = "crypto";
            rev = "v${old.version}";
